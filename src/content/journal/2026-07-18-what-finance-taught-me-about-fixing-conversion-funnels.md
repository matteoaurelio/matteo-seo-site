...
description: Not all the data is equally important. Not all the website changes
  are crucial to lift up conversion rates and, most importantly, correlation is
  not causation.
pubDate: 2026-07-18
tags:
...
To structure all the conversations, my mentor helped me to build a single tracker that became the source of truth. Every improvement idea, bug or open question had to be classified within a website page and topic. I also add a clear detail such as a URL to a Jira ticket where all the technical information lives. Lastly, assigning **Importance**, **Status**, **Dev Time Required** and **Comments** also help to prioritize and adds clarity to distinguish the most important elements from the least important.
